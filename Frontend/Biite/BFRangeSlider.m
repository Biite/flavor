...
- (UIImage *)trackBackgroundImage
{
    ...
    {
        UIImage *image = [UIImage imageNamed:@"slider_trackBackground_img"];
...
- (UIImage *)trackImage
{
    if(_trackImage==nil)
    {
        UIImage* image = [UIImage imageNamed:@"slider_track_img"];
        image = [image resizableImageWithCapInsets:UIEdgeInsetsMake(0.0, 2.0, 0.0, 2.0)];
        _trackImage = image;
    }
...
- (UIImage *)trackCrossedOverImage
{
    ...
    {
        UIImage *image = [UIImage imageNamed:@"slider_trackCrossedOver_img"];
        image = [image resizableImageWithCapInsets:UIEdgeInsetsMake(0.0, 2.0, 0.0, 2.0)];
...
- (UIImage *)lowerHandleImageNormal
{
    ...
    {
        UIImage *image = [UIImage imageNamed:@"slider_handle_img"];
