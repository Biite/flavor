/**
 * This is the install file for your new express-powered biite app.
 * If you have tasks that need to be completed prior to running the biite framework (such as creating initial
